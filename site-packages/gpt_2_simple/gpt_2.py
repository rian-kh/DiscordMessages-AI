# From gpt-2-simple, https://github.com/minimaxir/gpt-2-simple.
# Modified to print out steps of model training and text generation,
# and output samples in UTF8.

# Modified functions: finetune(), generate_samples(), generate()
...
def download_gpt2(model_dir='models', model_name='124M'):
    ...
    # Create file for download completion check
    open('models/' + model_name + '/downloadComplete', 'w')
